...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2020 at 04:07 PM
...
('\r\nhi hello...this is a blood bank ngo....');
...
('admin', 'admin', '9923456781', 'adminngo@gmail.com');
...
('9879123450', 'bloodbankngo@gmail.com'),
('9879123450', 'bloodbankngo@gmail.com');
...
-- Error reading data for table bloodbank.delete1: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `bloodbank`.`delete1`' at line 1
...
('th', 12, 'cc', 'O-', 23, '2020-04-09', 'female', '9923210127', '23 er road', 'avadi', 'Tamilnadu', 600111),
('th', 0, 'ccc', 'A+', 34, '2020-04-10', 'female', '9923210125', 'de', 'mumbai', 'Maharastra', 600090);
COMMIT;
