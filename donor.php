...
<h1 style="text-align:center" ><font color="lightgrey">BLOOD DONATION FORM</font></h1>
<center>
...
{    if($_POST['dob']>=18)
	...
	{ 
		...
		mysqli_query($link,"insert into donor values('$_POST[firstname]','$_POST[lastname]','$_POST[mail]','$_POST[bgrp]','$_POST[dob]','$_POST[gender]','$_POST[phone]' ,'$_POST[add]','$_POST[city]' ,'$_POST[state]','$_POST[zip]')");
